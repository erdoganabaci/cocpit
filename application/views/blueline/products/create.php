            ...
            <div class="row">
                <div class="col-md-12 col-xs-12">
                    ...
                    <div class="box">
                        ...
                        <!-- /.box-header -->
                        <form role="form" action="<?=site_url("/products/ekle"); ?>" method="post" enctype="multipart/form-data">
                            <div class="box-body">
                  ...
                  description" autocomplete="off">
                            ...
                            <div class="box-footer">
                                <button type="submit" class="btn btn-primary"><?=$this->lang->line('application_stock_addproduct_save');?></button>
