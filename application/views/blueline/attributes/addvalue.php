...
<div class="modal fade" tabindex="-1" role="dialog" id="addModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('attributesajax/createValue') ?>" method="post" id="createForm">
...
$(document).ready(function() {
  ...
  manageTable = $('#manageTable').DataTable({
    'ajax': base_url+'attributesajax/fetchAttributeValueData/'+<?php echo $attribute_data['id']; ?>,
    'order': []
  });
