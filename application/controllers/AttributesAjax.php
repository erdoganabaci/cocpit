...
class AttributesAjax extends CI_Controller
{
    ...
    public function fetchAttributeData()
    {
        ...
        foreach ($data as $key => $value) {
            ...
            // button
            $buttons = '<a href="'.base_url('attributesaddvalue/addvalue/'.$value['id']).'" class="btn btn-default"><i class="fa fa-plus"></i> Add Value</a> 
