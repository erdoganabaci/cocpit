...
class Attributes extends Admin_Controller
{
    ...
    */
    ...
    {
        //echo 'erdo';
       // $this->load->view("blueline/attributes/index");
       //$this->render_template('blueline/attributes/index');
       $this->content_view = 'attributes/index';
    ...
    */
    public function fetchAttributeData()
    {
        ...
        foreach ($data as $key => $value) {
            ...
            // button
            $buttons = '<a href="'.base_url('attributesajax/addvalue/'.$value['id']).'" class="btn btn-default"><i class="fa fa-plus"></i> Add Value</a> 
    ...
    */
    public function addvalue($attribute_id = null)
    {
       ...
       // $this->content_view = 'attributes/addvalue';
    }
